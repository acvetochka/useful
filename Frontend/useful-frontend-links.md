...
[Reactbits](https://www.reactbits.dev/) -  ресурс з купою готових анімацій текстів, зображень, компонентів та іншого.

## 11 безкоштовних сайтів для  розробників та дизайнерів,  які  допоможуть працювати швидше  🦾 

1.  [Omatsuri](https://omatsuri.app/) - 12 відкритих інструментів для дизайну, оптимізації та налагодження. Генерація градієнтів, декодування Base64 і багато іншого.  

2. [HTMLRev]( https://devhints.io/) - Безкоштовні шаблони для сайтів, блогів і портфоліо

3. [Unicornicons](https://unicornicons.com/) - Іконки з магією! Іконок не багато   але всі   вони круті й анімовані

4. [UiVerse](https://uiverse.io/) - Для будівництво красивих інтерфейсів!Понад 3000 готових CSS та Tailwind елементів.

5. [Undraw](https://undraw.co/) - Сучасні ілюстрації для кожного проєкту!Безкоштовні та налаштовувані SVG.

6. [PatternPad](https://patternpad.com/) - Генерація унікальних візерунків. Доволі незвичайний  сайт. Чимось на гру схожий) 

7. [Shape Divider](https://www.shapedivider.app/) -
Стильні криві для розділення секцій!

8. [Photopea](https://www.photopea.com/) - Ідеально для швидкого редагування прямо в браузері! Підтримує PSD, XD, Sketch та інші формати.

9. [QuickRef ](https://quickref.dev/) -
Шпаргалки для програміста в одному місці! Охоплює популярні мови, фреймворки та інструменти.

10. [DevDocs](https://devdocs.io/) -
Комбінує API-документації різних фреймворків. Доступ офлайн. 

11. [DevHints](https://devhints.io/) - Концентровані шпаргалки по популярних інструментах.


## ТОП платформ, щоб опанувати Frontend-розробку 

1️⃣ [freeCodeCamp](https://www.freecodecamp.org/) - 
Інтерактивні курси з HTML, CSS, JavaScript та навіть React. Навчаєтеся, пишете код у браузері й одразу отримуєте фідбек.

2️⃣ [The Odin Project](https://www.theodinproject.com/) - 
Структурований курс з фокусом на реальні проєкти. Вчитеся за планом, збираєте портфоліо і не блукаєте у хаосі туторіалів.

3️⃣ [Scrimba](https://scrimba.com/home) - 
Відеоуроки, у яких можна одразу редагувати код. Інтерактивний підхід допомагає краще засвоювати матеріал і швидше застосовувати знання на практиці.

4️⃣ [Frontend Mentor](https://www.frontendmentor.io/) - 
Завдання для створення реальних макетів, які допоможуть покращити навички верстки. Чудовий варіант для тих, хто хоче поповнити портфоліо.

        
[Awesome React](https://github.com/enaqx/awesome-react?tab=readme-ov-file) - це колекція найкращих ресурсів та інструментів для екосистеми React!⚛️
Цей репозиторій охоплює всі аспекти React, включаючи:

- Загальні ресурси та офіційні посібники.
- Фреймворки та інструменти для створення сучасних веб-додатків.
- Бібліотеки компонентів для швидкої розробки інтерфейсів.
- Управління станом та інструменти для ефективного оброблення даних.
- Стилізація компонентів та інтеграція з популярними CSS бібліотеками.
