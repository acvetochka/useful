...
**3) Порівняння exec та конвеєр | (pipe)?**
...
- Використовуйте `+` (Масове виконання) — для швидкості
  ...
  - Приклад:
    ...
    # (видалить усе за один запуск).
    ```

- Використовуйте `\;` (Поштучне виконання) — для складної логіки
  ...
  - Приклад:
    ...
    # (тут + не спрацює, бо mv не зрозуміє, що куди перейменовувати в масовому списку).
    ```
