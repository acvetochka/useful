...
2. HELP — Внутрішня довідка Shell
...
whereis python -> покаже всі шляхи, включаючи /usr/share/man/man1/python.1.gz.
6. LOCATE — Швидкий пошук у системі
...
7. MANDB — Адміністратор документації
