...
- [1. Блок-схема (Flowchart)](#1-блок-схема-flowchart)
- [2. Діаграма послідовності (Sequence Diagram)](#2-діаграма-послідовності-sequence-diagram)
- [3. Діаграма станів (State Diagram)](#3-діаграма-станів-state-diagram)
- [4. Кругова діаграма (Pie Chart)](#4-кругова-діаграма-pie-chart)
- [5. Діаграма Ганта (Gantt Chart)](#5-діаграма-ганта-gantt-chart)
- [6. ERD (Entity Relationship Diagrams)](#6-erd-entity-relationship-diagrams)
- [Важливі нюанси Mermaid:](#важливі-нюанси-mermaid)
- [Інші потужні інструменти Mermaid](#інші-потужні-інструменти-mermaid)
  - [1. Mind Maps (Ментальні карти)](#1-mind-maps-ментальні-карти)
  - [2. User Journey (Шлях користувача)](#2-user-journey-шлях-користувача)
  - [3. Git Graph (Візуалізація гілок Git)](#3-git-graph-візуалізація-гілок-git)
  - [4. Quadrant Chart (Матриця пріоритетів)](#4-quadrant-chart-матриця-пріоритетів)
  - [5. Timeline (Стрічка часу)](#5-timeline-стрічка-часу)
  - [6. Спеціальні фішки синтаксису:](#6-спеціальні-фішки-синтаксису)
    - [6.1. Інтерактивність (Click):](#61-інтерактивність-click)
    - [6.2. FontAwesome:](#62-fontawesome)
    - [6.3. Subgraphs (Підграфи):](#63-subgraphs-підграфи)
- [Cпецифічні діаграми для вузьких задач](#cпецифічні-діаграми-для-вузьких-задач)
  - [1. C4 Diagram (Архітектура систем)](#1-c4-diagram-архітектура-систем)
  - [2. State Diagram (Діаграма станів)](#2-state-diagram-діаграма-станів)
  - [3. Class Diagram (Діаграма класів)](#3-class-diagram-діаграма-класів)
  - [4. Sankey Diagram (Потоки даних/грошей)](#4-sankey-diagram-потоки-данихгрошей)
  - [5. XY Chart (Графіки)](#5-xy-chart-графіки)
  - [6. Конфігурація (Theming)](#6-конфігурація-theming)
- [Підсумок:](#підсумок)
...
#### 6.1. Інтерактивність (Click): 
Можна додати подію click до вузла, щоб при натисканні на нього в браузері відкривалося посилання.  
...
#### 6.2. FontAwesome: 
Mermaid підтримує іконки (наприклад, `:icon(fa fa-twitter)`), якщо підключена відповідна бібліотека.
...
#### 6.3. Subgraphs (Підграфи): 

Можна групувати вузли в рамки всередині блок-схем:
